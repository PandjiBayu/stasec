      ...
      <div className="w-full px-0 md:px-[118px] flex flex-col md:flex-row pt-[80px] ">
        <div className="flex flex-col space-y-[40px] md:py-[80px] w-full items-center md:items-start">
          ...
          <h2 className="text-center md:w-full md:text-left font-[16px] md:font-[18px]">
            Guiding you to a path of top-notch cybersecurity. We are devoted to
            shielding <br className="hidden md:block"/> your data and systems. With STASEC, it&apos;s not
            just software; it&apos;s a journey to a more <br className="hidden md:block"/> secure digital
            future.
          </h2>
